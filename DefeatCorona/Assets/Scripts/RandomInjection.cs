using System.Collections;
 ...
 public class RandomInjection : MonoBehaviour {
 
     public Sprite[] Injections; //this is an array of type sprite
     ...
     void Start () {
            ...
            code*/
            Render.sprite = Injections[Random.Range(0, Injections.Length)]; 
